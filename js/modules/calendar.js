        ...
        <section class="relative bg-white rounded-[2.5rem] p-8 mb-12 shadow-sm border border-slate-100 min-h-[350px] overflow-hidden"
            ...
            <div id="year-wrapped-${year}"
                ...
                <div class="flex justify-between items-center mb-4">
                    <h3 id="wrapped-title-${year}" class="text-xl font-black italic uppercase tracking-tighter">${year} Wrapped</h3>
                    <button onclick="window.toggleYearWrapped('${year}')"
                ...
                <div class="flex flex-col gap-2.5">
                    <div class="bg-white/10 p-4 rounded-[1.5rem] border border-white/10 flex justify-between items-center">
                        <div>
                            ...
                            <p class="text-3xl font-black italic leading-none">${gigCount}</p>
                        </div>
                        <div class="opacity-20" aria-hidden="true"><i data-lucide="ticket" class="w-8 h-8"></i></div>
                    </div>
                    <div class="bg-white/10 p-4 rounded-[1.5rem] border border-white/10 flex justify-between items-center">
                        <div>
                            <p class="text-[9px] font-bold uppercase opacity-60 tracking-widest mb-1">Total Artists</p>
                            <p class="text-2xl font-black italic leading-none">${artistCount}</p>
                        </div>
                        <div class="opacity-20" aria-hidden="true"><i data-lucide="mic-2" class="w-7 h-7"></i></div>
                    </div>
                    <div class="bg-white/10 p-4 rounded-[1.5rem] border border-white/10 flex justify-between items-center">
                        <div>
                            <p class="text-[9px] font-bold uppercase opacity-60 tracking-widest mb-1">Total Venues</p>
                            <p class="text-2xl font-black italic leading-none">${venueCount}</p>
                        </div>
                        <div class="opacity-20" aria-hidden="true"><i data-lucide="map-pin" class="w-7 h-7"></i></div>
                    </div>
                </div>
            </div>
